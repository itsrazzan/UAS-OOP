...
public class BattleArena extends World {
    ...
    // Posisi: Tengah bawah (x=800, y=870), Ukuran: Lebar layar (1600), Tinggi (40)= pas di atas tanah
    ...
    // 4. Tambahkan Platform dan objek lainnya
    addObject(new Platform(1600, 60, "transparent"), 800, 870);
    }
}